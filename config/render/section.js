...
export default [
   ...
   */
  {
    ...
    content: [
      ...
      p(),
      p('- 负责掌上重邮Android端代码开发与维护','[Linked](https://github.com/RedrockMobile/CyxbsMobile_Android)'),
      p(),
      p('- 负责了掌上重邮 ufield 模块的开发','[Linked](https://github.com/RedrockMobile/CyxbsMobile_Android/tree/develop/module_ufield)'),
      p(),
  ...
  },
  {
    ...
    content: [
      ...
      p(),
      p(`- *掌握Android基本组件:* 熟悉Android四大组件，熟悉使用 **RecyclerView**、Activity、Fragment 等常见组件。`),
      p(),
  ...
  },
  {
    ...
    content: [
      ...
      p(),
      p( `- *学习能力强* 具备较好的代码风格，编写代码时注重编码的通用标准和细节，追求代码的可读性和健壮性。`  ),
      p(),
      p( `- *善于团队合作* 具备较好的代码风格，编写代码时注重编码的通用标准和细节，追求代码的可读性和健壮性。`  ),
      p(),
      p( `- *责任心强* 对自己负责的项目认真负责`  ),
    ],
  },
  {
    ...
    content: [
      ...
      p('*负责模块:*'),
      p(
        '在该项目中负责ufield模块的主页、搜索和后台管理相关业务开发' +
        '分析源码后通过中转嵌套滑动解决。   ' +
